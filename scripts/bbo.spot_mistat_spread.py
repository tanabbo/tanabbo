...
# PURPOSE:      Calculates prognose of mortality index for spread spots
...
#% keywords: spread bark beetle spot mortality index
#%end
#%option
#% key: yearfrom
#% type: integer
...
def main():
    ...
    bboPrognosisLib.printMISeriesStatistics(yearFrom, yearTo, bboPrognosisLib.SPREADSPOTCODE)
