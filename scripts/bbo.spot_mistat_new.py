...
#%module
#% description: Calculates prognose of mortality index for new spots
#% keywords: new bark beetle spot mortality index
#%end
#%option
#% key: yearfrom
#% type: integer
...
def main():
    ...
    bboPrognosisLib.printMISeriesStatistics(yearFrom, yearTo, bboPrognosisLib.NEWSPOTCODE)
