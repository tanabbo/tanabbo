...
############################################################################
#
# MODULE:       bbo.spot_samples_generate
...
#% type: double
#% answer: 1.0
#% description: Absence multiplier
#% required: yes
#%end
...
def main():         
    ...
    absenceMulti = float(options["absencemulti"])

    bboLib.generateSpotSamplesSeries(yearFrom, yearTo, absenceMulti)
